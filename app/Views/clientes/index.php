                ...
                <div class="modal-header">
                    <h4 class="modal-title">Quer realmente excluir ?</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          ...
                          <p>Deseja realmente exluir este cliente?</p>
        ...
        <div class="row">
            ...
            <tr>
              ...
              <td>
                ...
                <button type="button" class="btn btn-danger" onclick="document.getElementById('id_cliente').value = '<?= $cliente['id_cliente']?>'"  data-toggle="modal" data-target="#modal-confirmacao-delete">
                <i class="fas fa-trash-alt"></i></button>
                                ...
                                <?php else: ?>
                                  <tr>
                                  <td colspan="7"> Não há nenhum cliente cadastrado </td>
                                </tr>
                          <?php endif; ?>
